...
int Contrast=120; // can be set from 0-255
...
void setup() {
  ...
  lcd.clear();
  lcd.setCursor(0,0);                                                  //Set the LCD cursor to position to position 0,0
  lcd.print("Y:");                                                 //Print text to screen
  lcd.setCursor(0,1);                                                  //Set the LCD cursor to position to position 0,1
  lcd.print("X:");                                                 //Print text to screen
...
void loop(){
  ...
  angle_roll_acc -= -87.2;                                               //Accelerometer calibration value for roll
...
void write_LCD(){                                                      //Subroutine for writing the LCD
  ...
  if(lcd_loop_counter == 10)lcd_loop_counter = 0;                      //Reset the counter after 14 characters
